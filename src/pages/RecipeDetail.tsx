    ...
    <section className=" flex justify-center items-center">
      <div className="flex flex-col justify-center h-full max-w-2xl">
        ...
        <div className="flex justify-evenly items-center mt-10">
          <div className="flex gap-2">
            <div className="flex flex-col justify-between">
              <img
                className=""
                src={liked ? iconLike : iconoLike}
                alt="views"
                onClick={handleLikeRecipe}
              />
              <p className="text-center">{totalLikes}</p>
            </div>
            <div className="flex flex-col justify-between">
              <img
                className=""
        ...
        <div className="flex flex-col justify-center mb-4">
          ...
          <p className="flex text-center justify-center align-items-center mr-3 ml-3">
        ...
        <div className="flex flex-col mt-16 w-full items-center mr-3 ml-3">
          ...
          <div className="flex flex-row mb-3 max-w-lg mr-3 ml-3">
            ...
            <p className="ml-2">
              Tasty, fresh, spicy and nutritious dish. I tried it first in Peru
              and then I made it at home. I can't get enough of it! You
              shouldn't miss it!
            </p>
          </div>
          <input
            className="flex w-full h-8 bg-gray-light"
            type="text"
